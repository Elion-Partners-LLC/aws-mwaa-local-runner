...
from elion.hooks.redshift_cluster import RedshiftHook
...
class RedshiftResumeClusterOperator(BaseOperator):
    ...
    def execute(self, context: Context):
        ...
        if cluster_state == "paused":
            ...
            raise Exception(
                f"Unable to resume cluster - cluster state is {cluster_state}"
            )
...
class RedshiftPauseClusterOperator(BaseOperator):
    ...
    def execute(self, context: Context):
        ...
        if cluster_state == "available":
            ...
            raise Exception(
                f"Unable to pause cluster - cluster state is {cluster_state}"
            )
